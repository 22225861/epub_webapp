...
export default {
  ...
  methods: {
    ...
    flapCardRotate () { // 转动细节
      const frontFlapCard = this.flapCardList[this.front] // 正面
      const backFlapCard = this.flapCardList[this.back] // 背面
    ...
    next () {
      ...
      frontFlapCard._g = frontFlapCard.g // 还原卡片角度
